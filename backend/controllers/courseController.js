...
export const getCreatorCourses = async (req, res) => {
  try {
    ...
    console.log("Error in getCreatorCourses controller: ", error);
    return res.status(500).json({
...
export const getCourseLecture = async (req, res) => {
  try {
    ...
    console.log("Error in getCourseLecture controller: ", error);
    return res.status(500).json({
...
export const editLecture = async (req, res) => {
  try {
    ...
    console.log("Error in editLecture controller: ", error);
    return res.status(500).json({
